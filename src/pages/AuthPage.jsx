...
const styles = {
  container: { minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '20px', position: 'relative', overflow: 'hidden', paddingBottom: '40px' },
  ...
  logoIcon: { fontSize: '56px', color: '#FF6B9D', filter: 'drop-shadow(0 0 20px rgba(233,30,99,0.5))' },
  logo: { fontFamily: "'Playfair Display', serif", fontSize: '64px', fontWeight: 700, color: '#fff', letterSpacing: '-2px', textShadow: '0 4px 40px rgba(233,30,99,0.5)', margin: 0 },
  ...
  card: { width: '100%', maxWidth: '420px', background: 'rgba(255,255,255,0.06)', backdropFilter: 'blur(30px)', WebkitBackdropFilter: 'blur(30px)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '28px', padding: '28px', zIndex: 1, boxShadow: '0 25px 50px -12px rgba(0,0,0,0.5)' },
  tabs: { display: 'flex', gap: '10px', marginBottom: '24px', background: 'rgba(255,255,255,0.05)', borderRadius: '14px', padding: '5px' },
  tab: { flex: 1, padding: '14px', borderRadius: '12px', fontSize: '15px', fontWeight: 600, color: 'rgba(255,255,255,0.6)', background: 'transparent', border: 'none', cursor: 'pointer', transition: 'all 0.3s ease', minHeight: '44px' },
  tabActive: { background: 'linear-gradient(135deg, #E91E63, #FF6B9D)', color: '#fff', boxShadow: '0 4px 15px rgba(233,30,99,0.4)' },
  subtitle: { textAlign: 'center', color: 'rgba(255,255,255,0.7)', fontSize: '15px', marginBottom: '24px' },
  form: { display: 'flex', flexDirection: 'column', gap: '16px' },
  inputGroup: { width: '100%' },
  input: { width: '100%', padding: '16px 20px', background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.12)', borderRadius: '14px', fontSize: '16px', color: '#fff', outline: 'none', transition: 'all 0.3s ease', boxSizing: 'border-box', minHeight: '56px', WebkitAppearance: 'none' },
  terms: { fontSize: '12px', color: 'rgba(255,255,255,0.4)', textAlign: 'center', lineHeight: 1.5 },
  submitBtn: { width: '100%', padding: '18px', background: 'linear-gradient(135deg, #E91E63, #FF6B9D)', border: 'none', borderRadius: '14px', fontSize: '17px', fontWeight: 600, color: '#fff', cursor: 'pointer', marginTop: '14px', boxShadow: '0 8px 25px rgba(233,30,99,0.4)', transition: 'all 0.3s ease', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', minHeight: '56px', WebkitAppearance: 'none' },
